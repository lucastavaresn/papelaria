...
from core.viewsets.seller_view import SellerComissionViewSet, SellerDetailView, SellerListView
...
urlpatterns = [
    ...
    path('sale/<int:pk>/', SaleViewSet.as_view({'get': 'retrivee', 'delete': 'delete', 'update': 'update'})),
