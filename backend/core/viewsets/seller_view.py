...
from django.db.models import (DecimalField, Expression, ExpressionWrapper, F,
                              FloatField, Q, Sum, Value)
        ...
        for seller in sellers:
            ...
            for sale in sales:
                ...
                for item in sale_items:
                    ...
                    comission_limits = Comission.objects.get(day_of_week=str(day_of_week))
                    ...
                    elif commission_percentage > Decimal(comission_limits.max_commission):
                        commission_percentage = Decimal(comission_limits.max_commission)

                    comission = (sold_amount * unit_value * commission_percentage) / Decimal('100.0')
